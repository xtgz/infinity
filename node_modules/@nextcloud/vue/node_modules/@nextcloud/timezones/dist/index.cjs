...
class Timezone {
  ...
  constructor(timezoneId, ics) {
    if (timezoneId instanceof ICAL__default.default.Timezone) {
      ...
      this._timezone = new ICAL__default.default.Timezone(timezoneId);
      this._initialized = true;
    } else {
  ...
  get timezone() {
    if (!this._initialized) {
      ...
      const iCalComponent = new ICAL__default.default.Component(jCal);
      this._timezone = new ICAL__default.default.Timezone(iCalComponent);
      this._initialized = true;
    }
    return this._timezone;
  }
  static get utc() {
    return new Timezone(ICAL__default.default.Timezone.utcTimezone);
  }
  static get floating() {
    return new Timezone(ICAL__default.default.Timezone.localTimezone);
  }
}
...
class TimezoneManager {
  ...
  registerTimezone(timezone) {
    ...
    ICAL__default.default.TimezoneService.register(timezone.toICALTimezone(), timezone.timezoneId);
    this._pendingAliases = this._pendingAliases.filter(([aliasName, timezoneId]) => {
      if (timezoneId !== timezone.timezoneId) {
        return true;
      }
      ICAL__default.default.TimezoneService.register(timezone.toICALTimezone(), aliasName);
      return false;
    });
  }
  ...
  registerAlias(aliasName, timezoneId) {
    ...
    ICAL__default.default.TimezoneService.register(resolvedTimezone.toICALTimezone(), aliasName);
  }
  /**
