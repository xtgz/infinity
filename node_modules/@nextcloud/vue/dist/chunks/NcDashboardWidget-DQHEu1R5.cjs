...
"use strict";
const NcAvatar = require("./NcAvatar-B8FOIz7P.cjs");
const NcDashboardWidgetItem = require("./NcDashboardWidgetItem-DgPiK40s.cjs");
...
//# sourceMappingURL=NcDashboardWidget-DQHEu1R5.cjs.map
